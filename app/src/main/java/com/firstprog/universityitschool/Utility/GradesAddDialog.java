...
public class GradesAddDialog {

    private Context context;
    private Dialog gradesAddDialog;
    ...
    public GradesAddDialog(Context context) {
        this.context = context;
    }

    //display editText view when clicking add button
    public void showDialog() {
        gradesAddDialog = new Dialog(context);
        gradesAddDialog.setContentView(R.layout.pdf_and_video_add_dialog);
        gradesAddDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        gradesAddDialog.setCanceledOnTouchOutside(true);

        uploadCardName = gradesAddDialog.findViewById(R.id.uploadCardName);
        uploadCardName.setText("Add New Grades");
        pdfScreenTitle = gradesAddDialog.findViewById(R.id.uploadScreenTitle);
        pdfScreenTitle.setText("Tap to Upload PDF");

        gradesAddDialog.create();
        gradesAddDialog.show();
    }


    //return button id to week pdf Fragment
    public Button submit() {
        return submit = gradesAddDialog.findViewById(R.id.btnSubmitFile);
    }

    public LinearLayout uploadAreaView(){
        return uploadArea_ = gradesAddDialog.findViewById(R.id.uploadArea);
    }
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            if (allSemID.equals(weekID)) {
                                newDatabaseReference = ds.child("week_grades").getRef();
    ...
    public void getPDFUrl(String weekID, String weekPreKey, String postID, Uri fillPath) {
        ...
        ref = storageReference.child("materials").child(weekID).child("grades/" + UUID.randomUUID().toString() + "." + "pdf");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                databaseReference.child(weekPreKey).child("week_grades").child(postID).child("pdfUrl").setValue(task.getResult().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
                                        gradesAddDialog.dismiss();
