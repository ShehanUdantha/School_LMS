...
public class Modules_Fragment extends Fragment implements BackPressedListener, RecyclerViewInterface {
    ...
    private BatchAddDialog batchAddDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!CheckNetwork.isConnected(context)) {
            ...
            batchAddDialog = new BatchAddDialog(context);
            ...
            batchData_adapter = new BatchData_Adapter(context, list, true, this);
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    batchAddDialog.showDialog("Add New Batch");

                    batchAddDialog.submit().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            batchAddDialog.uploadToFirebase();
                        }
                    });
                }
            });
    ...
    public void onItemClick(int Position, String value, String preValue) {
        ...
        bundle.putString("BatchKey",value);
