...
import com.firstprog.universityitschool.Adapters.Week_Grades_Adapter;
...
import com.firstprog.universityitschool.Utility.GradesAddDialog;
...
public class Week_Grades_Fragment extends Fragment implements RecyclerViewInterface, BackPressedListener {
    ...
    private Week_Grades_Adapter week_grade_adapter;
    private Uri filePath;
    private DatabaseReference databaseReference;
    private GradesAddDialog gradesAddDialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (!CheckNetwork.isConnected(context)) {
            ...
            databaseReference = FirebaseDatabase.getInstance("https://itschool-auth-default-rtdb.firebaseio.com").getReference("batch").child(batchPreNumber).child("batch_Sem").child(semesterPreNumber).child("semester_subject").child(subjectPreKey).child("weeks").child(weekPreKey).child("week_grades");

            list = new ArrayList<>();

            gradesAddDialog = new GradesAddDialog(context);
            ...
            week_grade_adapter = new Week_Grades_Adapter(context, list, batchPreNumber, semesterPreNumber, subjectPreKey, weekPreKey, this);
            recyclerView.setAdapter(week_grade_adapter);
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    gradesAddDialog.showDialog();

                    gradesAddDialog.uploadAreaView().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                    ...
                    gradesAddDialog.submit().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            gradesAddDialog.uploadPDFtoFirebase(fileName, filePath, weekKey, batchPreNumber, semesterPreNumber, subjectPreKey, weekPreKey);
                        }
                    });
                }
            });
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshots : dataSnapshot.getChildren()) {
                        PDFModel gardeM = dataSnapshots.getValue(PDFModel.class);
                        list.add(gardeM);
                    }
                    week_grade_adapter.notifyDataSetChanged();
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (filePath != null) {
                ...
                gradesAddDialog.updateFileName(fileName);
            }
        }
    }
    ...
    private void filterText(String newText) {
        ...
        if (filterList.isEmpty()) {
            ...
            week_grade_adapter.setFilteredList(filterList);
        }
    }
