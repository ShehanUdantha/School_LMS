...
public class Payment_Semester_Fragment extends Fragment implements BackPressedListener, RecyclerViewInterface {
    ...
    public void onItemClick(int Position, String value, String preValue) {
        ...
        Payment_View_Fragment payment_view_fragment = new Payment_View_Fragment();
        payment_view_fragment.setArguments(bundle);

        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.frameLayer, payment_view_fragment);
        ft.commit();
