...
import com.firstprog.universityitschool.Adapters.Week_Assignment_Adapter;
...
import com.firstprog.universityitschool.Utility.AssignmentsAddDialog;
...
public class Week_Assignments_Fragment extends Fragment implements RecyclerViewInterface, BackPressedListener {

    private Context context;
    private String batchPreNumber, semesterPreNumber, subjectPreKey, weekPreKey, weekKey, fileName;
    private ImageView btnAdd;
    private ArrayList<AssignmentsModel> list, filterList;
    private TextView mText;
    private Uri filePath;
    private RecyclerView recyclerView;
    private SearchView searchBar;
    private DatabaseReference databaseReference;
    private Week_Assignment_Adapter week_assignment_adapter;
    private AssignmentsAddDialog assignmentsAddDialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (!CheckNetwork.isConnected(context)) {
            ...
            assignmentsAddDialog = new AssignmentsAddDialog(context);

            databaseReference = FirebaseDatabase.getInstance("https://itschool-auth-default-rtdb.firebaseio.com").getReference("batch").child(batchPreNumber).child("batch_Sem").child(semesterPreNumber).child("semester_subject").child(subjectPreKey).child("weeks").child(weekPreKey).child("week_assignments");
            ...
            week_assignment_adapter = new Week_Assignment_Adapter(context, list, batchPreNumber, semesterPreNumber, subjectPreKey, weekPreKey, this);
            recyclerView.setAdapter(week_assignment_adapter);
            ...
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    assignmentsAddDialog.showDialog();

                    assignmentsAddDialog.uploadAreaView().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                    ...
                    assignmentsAddDialog.submit().setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            assignmentsAddDialog.uploadPDFtoFirebase(fileName, filePath, weekKey, batchPreNumber, semesterPreNumber, subjectPreKey, weekPreKey);
                        }
                    });
                }
            });
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshots : dataSnapshot.getChildren()) {
                        AssignmentsModel pdfM = dataSnapshots.getValue(AssignmentsModel.class);
                        list.add(pdfM);
                    }
                    week_assignment_adapter.notifyDataSetChanged();
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (filePath != null) {
                ...
                assignmentsAddDialog.updateFileName(fileName);
            }
        }
    }
    ...
    private void filterText(String newText) {
        ...
        for (AssignmentsModel pdfModel : list) {
            if(pdfModel.getAssignmentName().contains(newText)){
        ...
        if (filterList.isEmpty()) {
            ...
            week_assignment_adapter.setFilteredList(filterList);
        }
    }
