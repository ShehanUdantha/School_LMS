...
public class Events_Fragment extends Fragment implements BackPressedListener, RecyclerViewInterface {
    ...
    public void onItemClick(int Position, String value, String preValue) {
        ...
        Events_Semester_Fragment events_semester_fragment = new Events_Semester_Fragment();
        events_semester_fragment.setArguments(bundle);

        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.frameLayer, events_semester_fragment);
        ft.commit();
