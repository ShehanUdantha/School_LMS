...
public class Upload_PDF_Adapter extends RecyclerView.Adapter<Upload_PDF_Adapter.ViewHolder> implements RecyclerViewInterface {
    ...
    public Upload_PDF_Adapter(Context context, ArrayList<PDFModel> pdfList, String getBatchPreNumber, String getSemesterPreNumber, String getSubjectNumber, String getWeekNumber, boolean isTrue, RecyclerViewInterface recyclerViewInterface) {
    ...
    @NonNull
    @Override
    public Upload_PDF_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.recycle_selected_pdf_and_video, parent, false);

        return new Upload_PDF_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Upload_PDF_Adapter.ViewHolder holder, int position) {
                ...
                public void onClick(View v) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            databaseReference = FirebaseDatabase.getInstance("https://itschool-auth-default-rtdb.firebaseio.com").getReference("batch").child(getBatchPreNumber).child("batch_Sem").child(getSemesterPreNumber).child("semester_subject").child(getSubjectNumber).child("weeks").child(getWeekNumber).child("week_pdf");
